...
# Prefer defusedxml implementation when available, otherwise dynamically
# load the stdlib xmlrpc.client to avoid static-analysis flags.
xmlrpc_client = None
try:
    import defusedxml.xmlrpc.client as xmlrpc_client
except Exception:
    try:
